...
//       <div className="flex gap-4 sm:gap-10 border-b border-[#ACB2B0] cursor-pointer mb-6 lg:w-[930px]">
//         <p
...
//             ))}
//           </div>
//           <div className="w-full lg:w-[500px] bg-white rounded-lg shadow-2xl text-center p-4">
...
export default function Body() {
  ...
  return (
    <section className="px-4 sm:px-8 lg:px-16 py-4 mx-auto max-w-[1440px] bg-gray-50 lg:-mt-[120px]">
      <div className="flex gap-4 sm:gap-10 border-b border-[#ACB2B0] cursor-pointer mb-6 lg:w-[920px]">
        <p
          className={activeTab === 'Problems' ? 'text-black font-bold border-b-2 border-black' : 'text-gray-500'}
          onClick={() => setActiveTab('Problems')}
        >
